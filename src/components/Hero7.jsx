...
export default function Hero7() {
  return (
    <div className="grid gap-2 md:gap-10 text-white bg-[linear-gradient(145deg,#1678F2_3.73%,#65A8FB_132.69%)] px-10 md:px-16 py-6">
      <div className="md:flex md:justify-between grid gap-5 md:pt-5">
        ...
        <div className="grid gap-1">
          <h1 className="font-sora text-2xl font-semibold mb-4 md:mb-1">Contact</h1>
        ...
        <div className="grid gap-1">
          <h1 className="font-sora text-2xl font-semibold mb-4 md:mb-1">
            Company Info
          </h1>
      ...
      <div className="text-center">
        © Doctor all rights 2024 - Designed by Cedrick Byishimo
      </div>
    </div>
  );
}
